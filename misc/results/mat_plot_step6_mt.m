...
plot( run_step6_abc_mt( :, 1 ), run_step6_abc_mt( :, 5 ), '-.', 'LineWidth', 2, 'Color',  'k');

plot( run_step6_abc_mt( :, 1 ), run_step6_abc_mt( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'b' );
plot( run_step6_ab_mt( :, 1 ), run_step6_ab_mt( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'r' );
plot( run_step6_naive_mt( :, 1 ), run_step6_naive_mt( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'g' );
