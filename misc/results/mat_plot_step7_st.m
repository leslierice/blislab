...
plot( run_step7_abc_st( :, 1 ), run_step7_abc_st( :, 5 ), '-.', 'LineWidth', 2, 'Color',  'k');

plot( run_step7_abc_st( :, 1 ), run_step7_abc_st( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'b' );
plot( run_step7_ab_st( :, 1 ), run_step7_ab_st( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'r' );
plot( run_step7_naive_st( :, 1 ), run_step7_naive_st( :, 4), '.-', 'LineWidth', 1.3, 'Color',  'g' );
